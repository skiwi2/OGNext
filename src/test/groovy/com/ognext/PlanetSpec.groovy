 ...
 */
@TestFor(Planet)
@Mock([Coordinate, PlanetAlias, PlanetLocation, Universe, Buildings, Defences, Fleet])
...
class PlanetSpec extends Specification {
    ...
    void "save valid planet"() {
        ...
        def planet = new Planet(player: player, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
    ...
    void "save two planets with same planetId in same universe"() {
        ...
        def planet = new Planet(player: player, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
        def planet2 = new Planet(player: player, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
    ...
    void "save two planets with same planetId in different universe"() {
        ...
        def planet = new Planet(player: player, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
        def planet2 = new Planet(player: player2, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
    ...
    void "save valid planets belonging to same player"() {
        ...
        def planet = new Planet(player: player, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
        def planet2 = new Planet(player: player, planetId: 1001, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
    ...
    void "save different planets in same universe on same coordinates"() {
        ...
        def planet2 = new Planet(player: player2, planetId: 1001, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
    ...
    void "test equals and hash code"() {
        ...
        expect:
        new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet) == new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
        new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet) != new Planet(player: player2, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
        new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet) != new Planet(player: player, universe: universe2, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)
        new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet) != new Planet(player: player, universe: universe, planetId: 1001, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet)

        new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet).addToLocations(planetLocation) == new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet).addToLocations(planetLocation2)
        new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet).addToAliases(planetAlias) == new Planet(player: player, universe: universe, planetId: 1000, buildings: defaultBuildings, defences: defaultDefences, fleet: defaultFleet).addToAliases(planetAlias2)
    }
}
